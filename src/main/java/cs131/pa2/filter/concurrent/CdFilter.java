...
public class CdFilter extends ConcurrentFilter {
	 ...
	 * @throws Exception throws exception when there is an error in the parameters,
	 *                   or when the specified directory is not found
	 */
	...
	/**
	 * Sets the currentWorkingDirectory field of ConcurrentREPL to the specified
	 * directory.
	 */
